...
const PRODUCTS = [
  {
    ...
    description: "240 GSM combed cotton oversized T-shirt. Features high-density monochrome chest embroidery with subtle distressed edge detailing. Pre-shrunk and enzyme-washed for an authentic worn-in drape.",
  ...
  },
  {
    ...
    embroidery: "Tonal 3D puff embroidery on left wrist cuff + minimal spine mark.",
    sizes: ["S", "M", "L", "XL"],
    colors: ["Pitch Black"],
    featured: true,
    images: [
  ...
  },
  {
    ...
    description: "Relaxed drop-shoulder fit in breathable medium-weight jersey. Centered minimal geometric embroidery symbolizing disconnected frequency.",
